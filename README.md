...
6.3 - Mount context into components
----------------------------------------------------------------
...
and returns the current stateand a dispatchmethod.
...
8.useLayoutEffect
-----------------------------------------------------------------------------------------------------------
useLayoutEffect works similarly to useEffect but it called befor the user interface gets mounted.
...
9.customHook
-----------------------------------------------------------------------------------------------------------
React allow us to create own hook which is called as custom hook.

When you have component logic that needs to be used by multiple components, we can extract that logic to a custom Hook.

9.1 - Before creating hooks
----------------------------------------------------------------
App.jsx
----------------------------------------------------------------
import { useEffect, useState } from 'react'
...
//create new hooks & create 1 new file useLocalStorage.jsx inside it.
